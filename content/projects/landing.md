...
- **Публикация**. После выполнения задания публикуй проект на **GitHub** и присылай ссылку в [чат проекта](https://boosty.to/ilya.yurkin). Я с удовольствием дам обратную связь
...
По любым вопросам пиши в чат [Испытания багами](https://boosty.to/ilya.yurkin), и подписывайся канал [@js_is_easy](https://t.me/+jsgZ3_UEcoBlNjgy)
