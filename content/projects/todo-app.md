...
8. При нажатии на **кнопку “Удалить”** должен появляться [диалог](https://developer.mozilla.org/en-US/docs/Web/API/Window/confirm) “Вы действительно хотите удалить {название элемента}?” При выборе “Да” - убрать элемент из списка. При выборе “Нет” - ничего не происходит.
