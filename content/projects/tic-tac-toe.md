...
6. _Побочное задание_: прочитать книгу [“Грокаем Алгоритмы”](https://t.me/js_is_easy/51). Автор рассказывает про подходы к решению алгоритмов простым языком. Можно читать параллельно со следующими пунктами 
