...
??? ТЗ этого урока отличается от предыдущих проектов, оно заточено на менее подробно
Здесь ты применишь все знания, полученные на предыдущих этапах, а так же научишься новым технологиям, которые широко применяются в современной разработке.
Создавая CRM, ты научишься не только работать с бэкендом и API, но и планировать архитектуру приложения на современный лад.

## О проекте

## Чему научишься
- **Роутинг.** В прошлых проектах было не больше двух экранов и навигация была избытачна. Для удобной навигации по множеству страниц нужно иметь инструмент навигации
- **Работа с бэкендом.** Для этого урока настроен сервер, такой же, как на реальной работе. На нем буду храниться данные, которые вы создаете на своем фронтенде.
- **Авторизация и регистрация.** CRM - закрытая система и она должна быть защищена от посторонних.
- **Архитектура и декомпозиция.** В одном из прошлых уроков я писал, что folder-by-type структура плоха для больших проектов, в этом уроке мы рассмотрим альтернативу.
...
- Работа с API и данными
  - [Документация axios](https://axios-http.com/ru/docs/intro) - HTTP-клиент для JS приложений. Де-факто стандарт индустрии для работы с сетью.
  - [Документация @tanstack/react-query](https://tanstack.com/query/latest/docs/framework/react/installation) - библиотека для удобного хранения и манипулирования данными на сервере.
